...
function library:CreateWindow(name, size, hidebutton)
    ...
    window.NameLabel.FontFace = l_26
    ...
    function window:CreateTab(name)
        ...
        function tab:CreateSector(name,side)
            ...
            local size = textservice:GetTextSize(sector.name, 15, l_26, Vector2.new(2000, 2000))
            ...
            sector.Label.Size = UDim2.fromOffset(math.clamp(textservice:GetTextSize(sector.name, 15, l_26, Vector2.new(200,300)).X + 13, 0, sector.Main.Size.X.Offset), size.Y)
            ...
            function sector:AddToggle(text, default, callback, flag)
                ...
                function toggle:AddKeybind(default, flag)
                    ...
                    local size = textservice:GetTextSize(text, 15, l_26, Vector2.new(2000, 2000))
                ...
                function toggle:AddDropdown(items, default, multichoice, callback, flag)
                    ...
                    dropdown.SelectedLabel.FontFace = l_26
                ...
                function toggle:AddSlider(min, default, max, decimals, callback, flag)
                    ...
                    slider.InputLabel.FontFace = l_26
            ...
            function sector:AddColorpicker(text, default, callback, flag)
                ...
                colorpicker.Label.FontFace = l_26
            ...
            function sector:AddSeperator(text)
                ...
                local textSize = textservice:GetTextSize(seperator.text, l_26size, l_26, Vector2.new(2000, 2000))
                ...
                updateevent.Event:Connect(function(theme)
                    textSize = textservice:GetTextSize(seperator.text, l_26size, l_26, Vector2.new(2000, 2000))
        ...
        function tab:CreatePlayerlist(name)
            ...
            local size = textservice:GetTextSize(list.name, 13, l_26, Vector2.new(2000, 2000))
            ...
            list.Label.Size = UDim2.fromOffset(math.clamp(textservice:GetTextSize(list.name, 13, l_26, Vector2.new(200,300)).X + 10, 0, list.Main.Size.X.Offset), size.Y)
